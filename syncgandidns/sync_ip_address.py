...
def _sync_ip_address(domain: str, ipv4: Optional[str], ipv6: Optional[str], apikey: str) -> None:
...
def do_sync(domain: str, apikey: str, no_ipv6: bool, ipv4: str, ipv6: str) -> None:
    ...
    _sync_ip_address(domain, ipv4, ipv6, apikey)
